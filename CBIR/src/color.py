...
from evaluate import distance, evaluate_class, my_evaluate_class
...
if __name__ == "__main__":
    ...
    # evaluate database
    APs, prevision = my_evaluate_class(db_train, db_test, f_class=Color, d_type=d_type, depth=depth)
    cls_MAPs = []
